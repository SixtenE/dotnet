...
This project demonstrates a simple Web API built with ASP.NET Core **targeting .NET 10**, showcasing interactive API
...
- **[.NET SDK 10.0](https://dotnet.microsoft.com/download)** - Make sure you have the **.NET SDK 10.0** installed to build
  and run ASP.NET Core applications. This project is built and tested using **.NET 10**.
...
This template is a basic example to help you get started with building ASP.NET Core Web APIs using .NET 10 and
